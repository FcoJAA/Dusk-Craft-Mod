...
public class ModelfungusModel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("duskcarft", "modelfungus_model"), "main");
	public final ModelPart cuerpo;
	public final ModelPart pieL;
	public final ModelPart pieR;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cuerpo = partdefinition.addOrReplaceChild("cuerpo",
				CubeListBuilder.create().texOffs(21, 21).addBox(1.0F, -9.0F, 2.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(8, 21)
		...
		PartDefinition pieL = partdefinition.addOrReplaceChild("pieL",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, -0.25F, -0.5F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(1.5F, 19.0F, 0.5F));
		PartDefinition pieR = partdefinition.addOrReplaceChild("pieR",
				CubeListBuilder.create().texOffs(14, 18).addBox(-0.5F, -0.25F, -0.5F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-1.5F, 19.0F, 0.5F));
		PartDefinition cabeza = partdefinition.addOrReplaceChild("cabeza",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.5F, -2.0F, -3.5F, 8.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(14, 14)
