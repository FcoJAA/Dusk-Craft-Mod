...
public class DuskBiomeBiome {
	public static final Climate.ParameterPoint PARAMETER_POINT = new Climate.ParameterPoint(Climate.Parameter.span(-0.142857142857f, 0.142857142857f),
			...
			Climate.Parameter.span(0.646638115319f, 0.932352401033f), 0);

	public static Biome createBiome() {
		BiomeSpecialEffects effects = new BiomeSpecialEffects.Builder().fogColor(-13434778).waterColor(-16764109).waterFogColor(329011)
				.skyColor(-13434778).foliageColorOverride(-10092442).grassColorOverride(-10092442).build();
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("duskcarft:grass_dusk_biome", VegetationFeatures.PATCH_GRASS,
						List.of(NoiseThresholdCountPlacement.of(-0.8D, 5, 4), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE,
								BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("duskcarft:flower_dusk_biome", VegetationFeatures.FLOWER_DEFAULT, List.of(CountPlacement.of(4),
