...
public class WendigoEntity extends Monster {
	...
	public WendigoEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DuskcarftModEntities.WENDIGO.get(), world);
	}

	public WendigoEntity(EntityType<WendigoEntity> type, Level world) {
		super(type, world);
		xpReward = 1;
		setNoAi(false);
	}
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("duskcarft:wendigo_sound_1"));
	}
