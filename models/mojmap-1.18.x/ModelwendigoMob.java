...
public class ModelwendigoMob<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "wendigomob"), "main");
	private final ModelPart piernaR;
	private final ModelPart piernaL;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition piernaR = partdefinition.addOrReplaceChild("piernaR",
				CubeListBuilder.create().texOffs(29, 39)
						.addBox(-1.0F, 16.0F, -1.0F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(6, 36)
		...
		PartDefinition piernaL = partdefinition.addOrReplaceChild("piernaL",
				CubeListBuilder.create().texOffs(18, 39)
						.addBox(0.0F, 16.0F, -1.0F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(18, 18)
		...
		PartDefinition cuerpo = partdefinition.addOrReplaceChild("cuerpo",
				CubeListBuilder.create().texOffs(42, 23)
						.addBox(1.0F, -33.0F, -1.0F, 3.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(42, 22)
		...
		PartDefinition armR = partdefinition.addOrReplaceChild("armR",
				CubeListBuilder.create().texOffs(38, 8)
						.addBox(-3.0F, 0.0F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(37, 39)
		...
		PartDefinition armL = partdefinition.addOrReplaceChild("armL",
				CubeListBuilder.create().texOffs(34, 27)
						.addBox(4.0F, 15.0F, -1.5F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(41, 26)
		...
		PartDefinition cabeza = partdefinition.addOrReplaceChild("cabeza",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-3.0F, -7.0F, -5.5F, 6.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(14, 20)
						...
						.addBox(-1.0F, -1.0F, -6.5F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(26, 7)
